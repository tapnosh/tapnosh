      ...
      {open && (
        <RemoveScroll forwardProps>
          <motion.div
            ...
            className="fixed right-4 bottom-32 left-4 z-50 m-auto flex flex-col items-stretch overflow-clip border p-4 pb-0 shadow-[0px_0px_0.5rem_rgba(0,0,0,0.15)]"
          >
            <button
              onClick={() => setOpen(false)}
              className="text-muted-foreground hover:bg-muted hover:text-secondary absolute top-4 right-4 rounded-full p-1 transition-colors"
            >
              <X className="h-5 w-5" />
            </button>
            <article className="flex flex-col overflow-auto">
              ...
              <div className="pb-4">
                <div className="flex flex-col pt-2">
                  <h6 className="text-muted-foreground uppercase">
                    Ingredients
                  </h6>
                  <span className="mb-1">
              ...
              <footer className="border-muted bg-background sticky bottom-0 mt-auto flex items-end justify-between border-t pt-2 pb-4">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="border-muted-foreground flex items-center rounded-md border">
                    <button
                    ...
                    <button
                      ...
                      className="hover:bg-muted-foreground p-2 transition-colors"
                    >
